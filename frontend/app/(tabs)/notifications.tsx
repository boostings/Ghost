...
export default function NotificationsScreen() {
  ...
  const renderNotification = useCallback(
    ({ item }: { item: NotificationResponse }) => (
      ...
      >
        <GlassCard style={[styles.notificationCard, !item.isRead && styles.notificationUnread]}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              subtitle={
                loadError ||
                "You're all caught up! Notifications will appear here when there's activity on your questions."
              }
            />
          }
